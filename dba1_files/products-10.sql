...
insert into Inventory  (ProductCode, QuantityInStock) values ('artofsql', 52);
insert into Inventory  (ProductCode, QuantityInStock) values ('databaseid', 0);
insert into Inventory  (ProductCode, QuantityInStock) values ('mysqlian', 52);
insert into Inventory  (ProductCode, QuantityInStock) values ('mysqlspp', 5);
insert into Inventory  (ProductCode, QuantityInStock) values ('relationaldb', 14);
insert into Inventory  (ProductCode, QuantityInStock) values ('sqlhks', 32);
insert into Inventory  (ProductCode, QuantityInStock) values ('sqltuning', 105);